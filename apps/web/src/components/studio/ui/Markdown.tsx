...
const H = 'font-bold tracking-tight text-text-main';
  ...
  return (
    <ReactMarkdown
      components={{
        ...
        p:  (p) => <p className="mb-4 text-[14px] leading-[1.75] text-ink" {...p} />,
        ul: (p) => <ul className="mb-4 list-disc space-y-1.5 pl-5 text-[14px] leading-relaxed text-ink" {...p} />,
        ol: (p) => <ol className="mb-4 list-decimal space-y-1.5 pl-5 text-[14px] leading-relaxed text-ink" {...p} />,
        ...
        blockquote: (p) => (
          <blockquote className="mb-4 border-l-2 border-primary/40 pl-4 text-[14px] italic leading-relaxed text-text-body" {...p} />
        ),
        code: ({ className, ...p }) => {
          ...
          return bloco
            ? <code className="block overflow-x-auto rounded-lg bg-asset-bg p-4 font-mono text-[12px] leading-relaxed text-asset-ink" {...p} />
            : <code className="rounded bg-black/[0.06] px-1.5 py-0.5 font-mono text-[12.5px] text-text-main" {...p} />;
        },
        ...
        td: (p) => <td className="border-b border-black/[0.06] px-3 py-2 align-top text-ink" {...p} />,
