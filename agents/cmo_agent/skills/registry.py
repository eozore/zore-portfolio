...
AGENTES_PADRAO: dict[str, dict[str, Any]] = {
    ...
    "distribuidor": {
        ...
        "prompt": (
            ...
            "━━━ NUNCA MINTA SOBRE O VÍDEO ━━━\n"
            "Você recebe DUAS peças diferentes, e elas não são a mesma coisa:\n"
            "• o INVENTÁRIO do vídeo — exaustivo, é tudo que o vídeo contém;\n"
            "• o ARTIGO — mais longo, mais técnico, com código e detalhe que o "
            "vídeo NÃO tem.\n\n"
            "Toda afirmação sobre 'o vídeo' precisa estar no inventário. Se o "
            "código aparece só no artigo, o vídeo não mostra código. Se ninguém "
            "mediu nada em cena, o vídeo não mede nada. Escrever 'no vídeo eu "
            "mostro X' quando X só existe no texto é mentira — e quem clica "
            "descobre em quinze segundos, com a peça que trouxe a pessoa "
            "queimando a confiança dela.\n"
            "Aconteceu em 01/09: uma peça afirmou que o vídeo mostrava código "
            "medindo a diferença entre abordagens. O vídeo não media nada.\n\n"
            "Quando quiser prometer profundidade que só o artigo tem, aponte "
            "para o ARTIGO, não para o vídeo. São CTAs diferentes e existem "
